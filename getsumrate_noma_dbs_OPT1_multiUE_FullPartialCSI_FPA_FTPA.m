function [sumrate_DBS,sumrate_CB,sumrate_ZF,sumrate_dbsnoma_multiUE_fullCSI,sumrate_dbsnoma_2UE_fullCSI,sumrate_dbsnoma_multiUE_partialCSI,sumrate_dbsnoma_2UE_partialCSI,sumrate_dbsnoma_2UE_FPA1,sumrate_dbsnoma_2UE_FPA2,sumrate_dbsnoma_2UE_FPA3,sumrate_dbsnoma_2UE_FTPA,sumrate_dbsnoma_2UE_FTPA1,sumrate_dbsnoma_2UE_FPA1_ADI,sumrate_dbsnoma_2UE_FPA2_ADI,sumrate_dbsnoma_2UE_FPA3_ADI,sumrate_dbsnoma_2UE_FTPA_ADI,sumrate_dbsnoma_2UE_FTPA_ADI1]= getsumrate_noma_dbs_OPT1_multiUE_FullPartialCSI_FPA_FTPA(MU,Nt,Wt,sceType,TxArrayType,R,f,beta_seuil,scn,Pmin,Pe)
...
gamma_FPA1=0.1;gamma_FPA2=0.2;gamma_FPA3=0.3;
% N.B. the users belongs to the same side of BS, i.e., 0<theta<180.
while (r<=R)
