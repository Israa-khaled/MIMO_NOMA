function [SR_DBS,SR_CB,SR_ZF,SR_2UE_FPA_FCSI,SR_2UE_FPA_ADI,SR_2UE_FPA_dist,SR_2UE_FPA_HW]= getSR_2UE_diffUserOrdering_FPA(MU,Nt,Wt,sceType,TxArrayType,R,f,beta_seuil,scn,Pe,gamma_FPA1)
...
%% average SUM-RATE
SR_DBS=sum(sumrate_DBS1)/R;
SR_CB=sum(sumrate_CB1)/R;
SR_ZF=sum(sumrate_ZF1)/R;
% FCSI ZETA
SR_2UE_FPA_FCSI=sum(sumrate_dbsnoma_2UE_real_FPA1)/R;
% ADII ZETA 
SR_2UE_FPA_ADI=sum(sumrate_dbsnoma_2UE_real_FPA1_ADI)/R;
% Received power HW
SR_2UE_FPA_HW=sum(sumrate_dbsnoma_2UE_real_FPA1_ADI_HW)/R;
% Disatnnce
SR_2UE_FPA_dist=sum(sumrate_dbsnoma_2UE_real_FPA1_dist)/R;
